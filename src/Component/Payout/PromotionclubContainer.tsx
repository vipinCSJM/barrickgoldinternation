...
import { AffiliateIncome, PayoutTitle, ProfitSharingIncome, PromotionalIncomeReport, RewardReport } from "../../utils/Constant";
...
import { PromotionReport, ReportReport } from "../../Data/TableData/TableData";
...
//   const [Formvalue, setFormValue] = useState({})
 ...
 useMemo(()=>{
  ...
  setAPIPayload({
    procName:"GetPromotionIncome",
    Para:JSON.stringify({MemberId:ClientID, FromDate:formattedFromDate, ToDate:formattedToDate, ActionMode:"SelectByIdViewByMember"})
     //Para:JSON.stringify({ClientId:ClientID, ActionMode:"SelectByIdViewByMember"})
  })
 },[])
 ...
 const handleSubmit = (values: FormValues) => {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={PromotionalIncomeReport} parent={PayoutTitle} ChildName={PromotionalIncomeReport}/>
      <Container fluid>           
          <Formik
    ...
    <HistoryTable ColumnData={PromotionReport} SeaarchData_date={SeaarchData_date}   apiPayload={API_Payload}/>
      </Container>
    </>
  );
};

export default PromotionclubContainer;
