...
import { AffiliateIncome, PayoutTitle, ProfitSharingIncome } from "../../../utils/Constant";
...
//   const [Formvalue, setFormValue] = useState({})
 ...
 const handleSubmit = (values: FormValues) => {
  ...
  return (
    <>
      <Breadcrumbs mainTitle={AffiliateIncome} parent={PayoutTitle} ChildName={AffiliateIncome}/>
      <Container fluid>           
          <Formik
