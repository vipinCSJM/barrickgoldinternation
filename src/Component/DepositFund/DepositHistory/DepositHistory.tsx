...
import { DepositFundTitle, DepositHistoryTitle } from "../../../utils/Constant";
import Breadcrumbs from "../../../CommonElements/Breadcrumbs/Breadcrumbs";
import HistoryTable from "../../../CommonElements/SearchTable/SearchTable"
import { DepositHistory } from '../../../Data/TableData/TableData';
...
twoDaysAgo.setDate(twoDaysAgo.getDate() - 10);
   ...
   useMemo(()=>{
    ...
    setAPIPayload({
      ...
      Para:JSON.stringify({MemberId:memberID,FromDate:formattedFromDate, ToDate:formattedToDate, ActionMode:"GetHistory"})
    })
   },[])
  ...
  return (
    <>
      <Breadcrumbs mainTitle={DepositHistoryTitle} parent={DepositFundTitle} ChildName={DepositHistoryTitle} />
      <Container fluid>
      <Col xl="12">
          <Formik
    ...
    <SearchTable ColumnData={DepositHistory} SeaarchData_date={SeaarchData_date}  apiPayload={API_Payload}/>  
          </Col>
      </Container>
    </>
  );
