...
import { PayoutTitle, KingMakerzTransferLog } from "../../utils/Constant";
...
import { KingMakerzWalletReport, P2PWalletReport } from '../../Data/TableData/TableData';
...
const P2PWalletTransfer = () => {
  ...
  return (
    <>
    <Breadcrumbs mainTitle={KingMakerzTransferLog} parent={'Wallet Transfer'} ChildName={KingMakerzTransferLog}/>
         <Container fluid>
      <Formik
    ...
    >
      {({ setFieldValue, values, errors, touched }) => (
        <Form>
          ...
          <HistoryTable ColumnData={KingMakerzWalletReport} SeaarchData_date={SeaarchData_date} apiPayload={API_Payload}/>
      </Container>
    </>
  )
}
